        ...
        <Fade in={open}>
          <div className={classes.paper2}>
            ...
            >
              ...
              <label className="Modify_article_label" htmlFor="theme">
                Thème :
              </label>
              <select
              ...
              <label
                className="Modify_article_label Create_article_title"
              ...
              <input
                ...
                type="text"
                id="Modify_article_title"
                value={modifytitle}
                onChange={(e) => setModifytitle(e.target.value)}
              />

              <label
                className="Mofidy_article_label"
                htmlFor="Modify_article_body"
              >
                Corps de l'article :
              </label>
              <textarea
              ...
              ></textarea>
              <label
                className="Modify_article_label"
                htmlFor="Modify_article_image"
              >
                Ajouter une image :
              </label>

              <input
                {...register("Modify_article_upload_image", {
                  required: false,
                })}
                type="file"
                id="img"
